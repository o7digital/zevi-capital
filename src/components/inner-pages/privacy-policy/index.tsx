...
const content = {
  es: {
    ...
    sections: [
      ["Responsable y contacto", "ZeVi Capital, con domicilio en Cto. Plaza Bona Esmeralda 1, Bosque Esmeralda, 52930 Cd. López Mateos, México, es responsable del tratamiento de los datos recabados a través de este sitio. Para asuntos de privacidad: info@zevicapital.com."],
  ...
  en: {
    ...
    sections: [
      ["Controller and contact", "ZeVi Capital, located at Cto. Plaza Bona Esmeralda 1, Bosque Esmeralda, 52930 Cd. López Mateos, Mexico, controls data collected through this website. Privacy contact: info@zevicapital.com."],
  ...
  fr: {
    ...
    sections: [
      ["Responsable et contact", "ZeVi Capital, située Cto. Plaza Bona Esmeralda 1, Bosque Esmeralda, 52930 Cd. López Mateos, Mexique, est responsable des données collectées via ce site. Contact : info@zevicapital.com."],
