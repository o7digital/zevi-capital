...
export default function OliviaAI() {
  ...
  function revokePrivacy() { localStorage.removeItem("oliviaConsent:zevicapital"); localStorage.removeItem("oliviaConsentAt:zevicapital"); setConsent(false); }
